...
const Login = () => {
  ...
  const onSubmitHandler=(e)=>{
    ...
    let url;
    if(isLogin){
      url= 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyD-vt_LyHTrj3Myyjv9wniE8-YpBJqZIXg';
    }
      else{
        url= 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyD-vt_LyHTrj3Myyjv9wniE8-YpBJqZIXg';
      }
      fetch(url ,{
        method:'POST',
        body: JSON.stringify({
